...
/**
 * Repair individual lessons where attendance.student_id drifted from primary_student_id
 * (e.g. after reassignment). Planned lessons only — completed balance history is left as-is.
 */
export class RepairIndividualLessonAttendance1741000000000
  implements MigrationInterface
{
  name = 'RepairIndividualLessonAttendance1741000000000';
