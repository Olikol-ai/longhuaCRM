  ...
  return (
    <div className="flex flex-col items-center justify-center h-full py-24 gap-4 px-6">
      ...
      <div className="text-center">
        <h2 className="text-xl font-bold text-foreground mb-2">Аккаунт ожидает подтверждения</h2>
        <p className="text-muted-foreground max-w-sm">Ваш аккаунт создан, но ещё не получил роль. Администратор школы должен назначить вам роль (ученик или преподаватель). Пожалуйста, свяжитесь с администратором.</p>
      </div>
    </div>
  );
}
