  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 dark:from-indigo-950/40 via-white dark:via-slate-950 to-slate-50 dark:to-slate-950 flex items-center justify-center p-6">
      <div className="max-w-lg w-full text-center space-y-8">
        ...
        {/* Main card */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl shadow-slate-100 border border-slate-100 dark:border-slate-800 p-10 space-y-6">
        ...
        <div className="flex flex-col items-center gap-3">
          {user && (
            <p className="text-xs text-slate-400">
              Вы вошли как: <span className="font-medium text-slate-600 dark:text-slate-400">{user.email}</span>
            </p>
          )}
          <Button
            variant="ghost"
            ...
            className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-400 gap-2"
          >
