...
const EXACT_ROUTE_ACCESS = {
  ...
  '/HskAcademy': ['admin', 'teacher', 'student'],
  '/HskAcademyPractice': ['admin', 'teacher', 'student'],
  '/HskAcademyMock': ['admin', 'teacher', 'student'],
  '/HskAcademyPreparation': ['admin', 'teacher', 'student'],
  '/HskAcademyTake': ['admin', 'teacher', 'student'],
  '/HskAcademyResult': ['admin', 'teacher', 'student'],
  '/HskAcademyBank': ['admin', 'teacher'],
  '/ExamContent': ['admin', 'teacher'],
  '/ExamContentBank': ['admin', 'teacher'],
  '/ExamContentMedia': ['admin', 'teacher'],
  '/ExamContentExams': ['admin', 'teacher'],
  '/ExamContentOps': ['admin', 'teacher'],
